...
@if(isset($plano))
    <textarea rows="5" type="text" id="customerSegment" name="customerSegment" placeholder="" class="form-control" value="{{$plano->customerSegment}}"></textarea>
@else
...
@if(isset($plano))
    <textarea rows="5" type="text" id="keyActivities" name="keyActivities" placeholder="" class="form-control" value="{{$plano->keyActivities}}"></textarea>
@else
